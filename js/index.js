...
function cargarProductos() {
    productos.push(new Producto(1, 'Cartas Yu-Gi-Oh', 550, '/imagenes/accesorios/cartas-yugioh.webp'));
    productos.push(new Producto(2, 'Pines variados de anime y videojuegos', 150, '/imagenes/accesorios/pines.webp'));
    productos.push(new Producto(3, 'Manga Boku no Hero ', 750, 'imagenes/mangas/boku-no-hero.webp'));
    productos.push(new Producto(4, 'Manga Death Note', 750, 'imagenes/mangas/death-note.webp'));
    productos.push(new Producto(5, 'Manga Naruto Shipudden', 700, 'imagenes/mangas/naruto.webp'));
    productos.push(new Producto(6, 'Manga One piece', 750, 'imagenes/mangas/one-piece.webp'));
    productos.push(new Producto(7, 'Buzo Nezuko negro, talle M a XXL', 5000, 'imagenes/ropa/buzo-nezuko.webp'));
    productos.push(new Producto(8, 'Gorro de pikachu', 2500, 'imagenes/ropa/gorro-pikachu.webp'));
}
